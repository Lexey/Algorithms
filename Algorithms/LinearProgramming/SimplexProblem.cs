...
namespace Algorithms.LinearProgramming
{
    ...
    public class SimplexProblem
    {
        ...
        private SimplexResult SolvImpl(int[] startBasis, out Vector x, out double value, out int[] basisIndices, bool bypassLinearization)
        {
        ...
        /// <param name="basisIndices">Индексы базиса оптимума</param>
        /// <returns>Результат вычислений</returns>
        public SimplexResult Solv(out Vector x, out double value, out int[] basisIndices)
        {
            basisIndices = null;
            // инициализация
            x = new Vector(A.Columns);
